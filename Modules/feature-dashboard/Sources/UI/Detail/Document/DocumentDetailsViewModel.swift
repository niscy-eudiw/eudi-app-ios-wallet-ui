    ...
    .init(
      trailingActions: [
        .init(
          ...
          accessibilityLocator: viewState.isBookmarked ? ToolbarLocators.bookmarkIconFill : ToolbarLocators.bookmarkIcon
        ) {
          self.saveBookmark(self.viewState.document.id)
        },
        .init(
          image: isVisible ? Theme.shared.image.eyeSlash : Theme.shared.image.eye,
          accessibilityLocator: isVisible ? ToolbarLocators.eyeSlash : ToolbarLocators.eye
        ) {
