...
////                  mainText: row.title,
////                  trailingContent: .checkbox(row.isSelected, { _ in
...
//              ExpandableCardView(title: section.title, subtitle: "", listItems: []) {
...
//                      listItem: ListItemData(
//                        mainText: item.title,
//                        trailingContent: .checkbox(item.isSelected, { _ in
...
//              Text("")
              //              WrapListItemView(
              //                listItem: ListItemData(
              //                  mainText: verification.title,
              //                  trailingContent: .checkbox(verification.isSelected, { _ in })
              //                )
              //              )
//            }
